const CACHE='nutritrack-v7-online-food-myfoods-renpho-weightplan';
const ASSETS=['./','./index.html','./styles.css','./app.js','./online-food-search.js','./weight-plan.js','./manifest.webmanifest'];
